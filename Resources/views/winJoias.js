...
var imageContainer = [];
var imageRepository = Titanium.Filesystem.getFile(Titanium.Filesystem.resourcesDirectory + 'views/joias/').getDirectoryListing();
...
for (var file in imageRepository) {
	...
	if (imageRepository[file].split(".")[1] === "jpeg") {
		imageContainer.push(Titanium.UI.createImageView({
			image : 'joias/' + imageRepository[file]
		}));
	};
